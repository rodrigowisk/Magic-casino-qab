  ...
  <div class="admin-layout">
    <div class="flex flex-col flex-1 h-full overflow-hidden">
      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <main class="content-area bg-[#121214] text-[#e1e1e6]">
...
.top-nav { display: flex; gap: 5px; background: #121214; padding: 5px; border-radius: 8px; }
.nav-item { display: flex; align-items: center; gap: 8px; padding: 8px 16px; color: #a8a8b3; text-decoration: none; font-size: 0.9rem; font-weight: 600; border-radius: 6px; transition: 0.2s; }
.nav-item:hover { color: #fff; background: rgba(255,255,255,0.05); }
.nav-item.active { background-color: #ffd700; color: #121214; }
.sidebar { width: 240px; background-color: #1c1c1e; border-right: 1px solid #323238; display: flex; flex-direction: column; flex-shrink: 0; }
.menu-title { padding: 20px; font-size: 0.75rem; font-weight: bold; color: #7c7c8a; text-transform: uppercase; letter-spacing: 1px; }
.side-menu { display: flex; flex-direction: column; padding: 0 10px; gap: 5px; }
.side-item { padding: 12px 15px; color: #e1e1e6; text-decoration: none; font-size: 0.95rem; border-radius: 4px; transition: 0.2s; display: flex; align-items: center; gap: 10px; }
